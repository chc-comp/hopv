...
(assert
  (forall ( (|$V-reftype:3| Int) (|$alpha-10:n| Int) (|$alpha-9:z| Int) (|$knormal:21| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:21|)) (= |$alpha-9:z| 0)) (not (= 0 |$knormal:21|)) (|dotprod$unknown:2| |$V-reftype:3| |$alpha-10:n|) )
      (|make_array$unknown:10| |$V-reftype:3| |$alpha-10:n|)
    )
  )
)
(assert
  (forall ( (|$V-reftype:25| Int) (|$alpha-10:n| Int) (|$alpha-9:z| Int) (|$knormal:21| Int) (|$knormal:32| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:21|)) (= |$alpha-9:z| 0)) (not (= 0 |$knormal:21|)) (|make_array$unknown:11| |$V-reftype:25| |$knormal:32| |$alpha-10:n|) (|dotprod$unknown:2| |$knormal:32| |$alpha-10:n|) )
      (|dotprod$unknown:3| |$V-reftype:25| |$knormal:32| |$alpha-10:n|)
    )
  )
)
(assert
  (forall ( (|$V-reftype:7| Int) (|$alpha-10:n| Int) (|$alpha-9:z| Int) (|$knormal:21| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:21|)) (= |$alpha-9:z| 0)) (not (= 0 |$knormal:21|)) (|dotprod$unknown:4| |$V-reftype:7| |$alpha-10:n|) )
      (|make_array$unknown:10| |$V-reftype:7| |$alpha-10:n|)
    )
  )
)
(assert
  (forall ( (|$V-reftype:25| Int) (|$alpha-10:n| Int) (|$alpha-9:z| Int) (|$knormal:21| Int) (|$knormal:31| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:21|)) (= |$alpha-9:z| 0)) (not (= 0 |$knormal:21|)) (|make_array$unknown:11| |$V-reftype:25| |$knormal:31| |$alpha-10:n|) (|dotprod$unknown:4| |$knormal:31| |$alpha-10:n|) )
      (|dotprod$unknown:5| |$V-reftype:25| |$knormal:31| |$alpha-10:n|)
    )
  )
)
(assert
...
(assert
  (forall ( (|$alpha-9:z| Int) (|$knormal:21| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:21|)) (= |$alpha-9:z| 0)) (not (= 0 |$knormal:21|)) )
      true
    )
  )
)
...
(assert
  (forall ( (|$alpha-10:n| Int) (|$alpha-9:z| Int) (|$knormal:21| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:21|)) (= |$alpha-9:z| 0)) (not (= 0 |$knormal:21|)) )
