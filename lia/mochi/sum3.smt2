...
(assert
  (not (exists ( (|$alpha-2:n| Int) (|$knormal:5| Int) (|$knormal:6| Int) (|$knormal:7| Int) (|$knormal:9| Int) )
    ( and (= (not (= 0 |$knormal:9|)) (<= |$knormal:6| |$knormal:7|)) (= |$knormal:6| (- |$knormal:5| 3)) (= |$knormal:5| (* 3 |$alpha-2:n|)) (not (not (= 0 |$knormal:9|))) (|sum$unknown:2| |$knormal:7| |$alpha-2:n|) )
    )
  )
)
(assert
  (forall ( (|$alpha-2:n| Int) (|$knormal:5| Int) (|$knormal:6| Int) )
    (=>
      ( and (= |$knormal:6| (- |$knormal:5| 3)) (= |$knormal:5| (* 3 |$alpha-2:n|)) )
      true
    )
  )
)
