...
(assert
  (not (exists ( (|$alpha-2:n| Int) (|$knormal:6| Int) (|$knormal:7| Int) (|$knormal:9| Int) )
    ( and (= (not (= 0 |$knormal:9|)) (= |$knormal:7| 91)) (= (not (= 0 |$knormal:6|)) (<= |$alpha-2:n| 99)) (not (not (= 0 |$knormal:9|))) (not (= 0 |$knormal:6|)) (|m$unknown:2| |$knormal:7| |$alpha-2:n|) )
    )
  )
)
(assert
  (forall ( (|$alpha-2:n| Int) (|$knormal:6| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:6|)) (<= |$alpha-2:n| 99)) (not (= 0 |$knormal:6|)) )
      true
    )
  )
)
